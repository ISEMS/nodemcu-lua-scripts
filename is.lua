...
if file.exists("board.lua") then

    print("Board specification file board.lua found. We have board calibration data. Great!")
    dofile"board.lua"

else

    print("WARNING: Board specification file board.lua not found. Loading default values!")
    print("This affects accuracy of analog temperature sensor measurement and ")
